...
<body class="h-[100vh] w-[100vw] bg-gray-100 flex justify-center items-center relative">
    <div class="h-full w-full max-w-3xl bg-white overflow-hidden shadow-lg relative">
        <div class="bg-red-600 h-48 w-full rounded-br-full relative flex flex-col items-center justify-center text-white">
            <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center overflow-hidden">
                <img src="assets/LogoMinhAnh.png" alt="Logo Minh Anh" class="w-20 h-20 object-contain"/>
            </div>
            <h1 class="text-xl font-bold mt-2">MINH ANH</h1>
        </div>

        <div class="px-6 py-6 mt-10">
            <h2 class="text-red-600 text-xl font-medium mb-2 text-center">QUẢN LÝ KHO NHẬP KHO</h2>
            <p class="text-gray-500 text-sm mb-6 text-center">Đăng nhập vào tài khoản để tiếp tục</p>

            <form method="POST" class="h-[32vh] flex flex-col justify-between space-y-4 mt-10">
                <div class="space-y-4">
                    <div class="bg-green-50 rounded-md p-3 flex items-center">
                        <img src="assets/User.png" alt="User" class="w-5 h-5 object-contain" />
                        <input type="text" name="taiKhoan" value="<?php echo htmlspecialchars($savedTaiKhoan); ?>" placeholder="Tài khoản" class="w-full bg-transparent focus:outline-none text-gray-700 pl-2" >
                    </div>

                    <div class="bg-green-50 rounded-md p-3 flex items-center relative">
                        <img src="assets/Lock.png" alt="Lock" class="w-5 h-5 object-contain" />
                        <input type="password" name="matKhau" id="password" placeholder="Mật khẩu" class="w-full bg-transparent focus:outline-none text-gray-700 pl-2 pr-10">
                        <button
                            type="button"
                ...
                <button type="submit" class="w-full bg-red-600 text-white py-2 rounded-full hover:bg-red-700 transition duration-300 text-base mb-4">ĐĂNG NHẬP</button>
            </form>
        </div>
    </div>
    ...
    <?php if ($error): ?>
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 error-modal animate-fadeIn">
        <div class="bg-white rounded-lg w-full max-w-md overflow-hidden shadow-xl">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-end">
                    <button onclick="document.querySelector('.error-modal').style.display='none';" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition-all duration-200">
                        Đóng
                    </button>
                </div>
            </div>
